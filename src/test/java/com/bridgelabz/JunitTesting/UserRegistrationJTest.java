...
public class UserRegistrationJTest {
	...
	public void givenPasswordRule3_WhenProper_ShouldReturnTrue() {
		boolean result = userRegistration.passwordRule3("naveen@123");
		Assert.assertEquals(true, result);
	}

	@Test
	public void givenPasswordRule3_WhenNotProper_ShouldReturnFalse() {
		boolean result = userRegistration.passwordRule3("naveen@gn");
		Assert.assertEquals(false, result);
	}
	...
	public void givenPasswordRule4_WhenNotProper_ShouldReturnFalse() {
		boolean result = userRegistration.password("navi22");
		Assert.assertEquals(false, result);
	}
	...
	public void givenEmail9_WhenNotProper_ShouldReturnFalse() {
		boolean result = userRegistration.emailIdValidator("abc..2003@gmail.com");
		Assert.assertEquals(false, result);
	}
